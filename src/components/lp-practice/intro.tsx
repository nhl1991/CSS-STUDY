...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      <div
        id="title"
        className="w-full flex items-center justify-center bg-zinc-400 text-[14rem] blend"
      >
        <p>日</p>
        <p>本</p>
      </div>
      ...
      >
        <label htmlFor="scroll_next" className=" cursor-pointer">SEE MORE</label>
        <button
          id="scroll_next"
          className="rounded-full flex items-center p-2 justify-center bg-black"
